...
// Bạn có thể lấy nó ở đâyBiểu bản đồ chiều rộng, chiều cao, v.v.
const { w, h } = toRefs(props.chartConfig.attr)
// Bạn có thể lấy nó ở đây config.ts bên trong option dữ liệu
...
// Cập nhật dữ liệu (Cập nhật mặc định dataset, nếu có các thao tác khác sau khi cập nhật, bạn có thểThêmchức năng gọi lại)
