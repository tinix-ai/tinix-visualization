...
const toggleFullscreen = () => {
  ...
  // Vì thay đổi trạng thái toàn màn hình sẽ không có hiệu lực ngay lập tức nên bạn cần trì hoãn một lúc trước khi có được trạng thái toàn màn hình.
  setTimeout(() => {
    checkFullscreen()
  }, 1000)
}

// Theo dõi các thay đổi về trạng thái toàn màn hình để đảm bảo rằng trạng thái của nhiều thành phần toàn màn hình là nhất quán
onMounted(() => {
