            ...
            [ComponentInteractEventEnum.DATA]: [
                {
                    ...
                    label: (typeof window !== 'undefined' && window['$t'] ? window['$t']('phase7.auto_55') : 'Số trang')
                },
                {
                    value: ComponentInteractParamsEnum.DATA2,
                    label: (typeof window !== 'undefined' && window['$t'] ? window['$t']('phase7.auto_259') : 'Số mục trên mỗi trang')
                }
            ]
        }
    }
