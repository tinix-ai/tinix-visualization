...
const ionicons5 = {
  ...
  // Lớp
  LayersIcon,
  // Cài đặt chi tiết thành phần (lăng kính)
  PrismIcon,
  // khối lập phương
  ConstructIcon,
  // nếp gấp/quay lại
  ChevronBackOutlineIcon,
  // Dữ liệu phụ trợ (Lightning)
  FlashIcon,
  // Cài đặt (Bánh răng)
  SettingsSharpIcon,
  // quay lại
...
// https://www.xicons.org/#/ Còn nhiều nữa
