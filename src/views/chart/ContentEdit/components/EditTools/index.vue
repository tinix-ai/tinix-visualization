...
// Sửa (Edit)đối phó với
const editHandle = () => {
  window['$message'].warning(window['$t']('views_components.auto_280'))
...
// đưa vào bộ nhớDữ liệuĐồng bộ hóa vớiSessionStorage Thuận tiện chuyển sang khởi tạo cửa sổ mớiDữ liệu
...
const btnList: BtnListType[] = [
  {
    ...
    name: window['$t']('views_components.auto_283'),
    icon: ShareIcon
  },
  {
    key: 'export',
    type: TypeEnum.BUTTON,
    name: window['$t']('views_components.auto_281'),
    icon: DownloadIcon,
    handle: exportHandle
  },
  {
    key: 'edit',
    type: TypeEnum.BUTTON,
    name: window['$t']('views_components.auto_122'),
    icon: CreateIcon,
    handle: editHandle
  },
  {
    key: 'setting',
    type: TypeEnum.BUTTON,
    name: window['$t']('views_components.auto_282'),
