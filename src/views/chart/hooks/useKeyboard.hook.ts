...
// KeymasterCác tổ hợp phím sau đây có thể được nhận dạng: ⇧，shift，option，⌥，alt，ctrl，control，command, và ⌘
...
// cái này Ctrl Sau đó nó được thay thế bằng ⌘
...
// không có bài kiểm tra macOS Hệ thống, vì tôi không có nó😤👻
