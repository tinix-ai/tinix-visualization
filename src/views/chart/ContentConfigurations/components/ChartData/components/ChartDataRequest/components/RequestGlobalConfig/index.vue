<template>
  <!-- Cấu Hình System Base -->
  <n-card class="n-card-shallow">
    <n-tag type="info" :bordered="false" style="border-radius: 5px"> {{ $t('phase7.auto_96') }} </n-tag>
    <setting-item-box
      :name="$t('views_components.auto_189')"
    ...
    >
      <!-- nguồnURL -->
      <setting-item :name="$t('views_components.auto_186')"
>
        <n-input
          v-model:value.trim="requestOriginUrl"
          :disabled="editDisabled"
          :placeholder="$t('phase7.auto_287')"
        ></n-input>
      </setting-item>
...
>
        <n-input-group>
          <n-input-number
            ...
            :show-button="false"
            :disabled="editDisabled"
            :placeholder="$t('views_components.auto_188')"
